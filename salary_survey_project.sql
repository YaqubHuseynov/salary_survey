...
SET Country = 
	CASE
        ...
        WHEN Country LIKE '%cr%' THEN 'Croatia'
        WHEN Country LIKE '%nig%' THEN 'Nigeria'
        WHEN Country LIKE '%fran%' THEN 'France'
        WHEN Country LIKE '%pak%' THEN 'Pakistan'
        WHEN Country LIKE '%sin%' THEN 'Singapore'
        WHEN Country LIKE '%africa%' THEN 'South Africa'
        WHEN Country LIKE '%spa%' THEN 'Spain'
        WHEN Country LIKE '%sri%' THEN 'Sri Lanka'
        ELSE Country
	END;
